...
Due to the complexity of calculating the value of the loss function, the frequency extraction scales at least as $\mathcal{O}(NM)$ if $N$ and $M$ are the number of points for current $I$ and frequency $f_p$, respectively, and the following optimization scales linearly with $N$. 
...
We gratefully acknowledge valuable discussions with Ilya Besedin and Valery Ryazanov. This work was partially supported by the Ministry of Education and Science of Russian Federation in the framework of Increase Competitiveness Program of the NUST MISIS (contract no. K2-2017-081). Experiments and analytical tools were developed with the financial support from the Russian Science Foundation (contract no. 16-12-00095).
